...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Categoria</h2>
    ...
    <div class="agregar">
         <button href="#" type="button" id="nuevo_categoria" class=" btn btn-info" data-toggle="modal">Nuevo Categoria</button>
        </div>
      ...
      <div class="modal-content">
        <div class="modal-header bmodal-header-success">
          ...
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            ...
            <form id="mAgregarcategoria">
                <div class="modal-body ">
                    <label>Nombre Categoria</label><input type="text" class="form-control input-sm" id="nameacategoria"  name="nameacategoria">
                </div>
