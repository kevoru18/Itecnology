...
<div class="row">
    ...
    <div class="agregar">
         <button href="#" type="button" id="nuevo_cliente" class=" btn btn-info" data-toggle="modal">Nuevo Cliente</button>
        </div>
  ...
  //leer();
    ...
    <tr>
        ...
        <td class="center"><?php  echo $a['rtn'];?></td>
        <td class="center"><?php  echo $a['telefono_p'];?></td>
        <td class="center"><?php  echo $a['direccion_p'];?></td>
        <td class="center"><?php  echo $a['empresa'];?></td>
        <td class="center"><?php  echo $a['usuario'];?></td>
        <td class="center"><?php  echo $a['clave'];?></td>
        
        <td class="center">
            <span id="estado" class="label-success label label-default"><?php  echo $a['estatus'];?></span>
        </td>
        <td class="center">
            ...
            <a class="btn btn-danger" href="./php/inactivar_cliente.php?Id='<?php echo $a['id_cliente'];?>'">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body ">
          ...
          <label >Teléfono</label><input type="text" class="form-control input-sm" id="phoneacliente"  name="phoneacliente">
          <label >Dirección</label><input type="text" class="form-control input-sm" id="addresscliente"  name="addresscliente">
