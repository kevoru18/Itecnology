...
<div class="row">
    ...
    <div class="box-content">
         <div class="agregar">
             <button href="#" type="button" id="nuevo_compra" class=" btn btn-info" data-toggle="modal">Nueva Compra</button>
         </div>
         ...
         <table class="table table-striped table-bordered bootstrap-datatable  responsive">
            <thead>
             ...
             <?php
                 ...
                 $sql="select distinct num_factura from  orden_pedido where estado='Pendiente'";
                 $resultado=$base->prepare($sql);
                 $resultado->execute();
                while ($a = $resultado->fetch(PDO::FETCH_ASSOC)) {
                    $factura_pendiente=$a['num_factura'];
                    $registros1="SELECT * FROM orden_pedido WHERE num_factura='$factura_pendiente' and estado='Pendiente'";
                ...
                <td class="text-center"><?php  echo $b['id_producto']  ?></td>
                <?php $id=$b['id_producto'];
                  $prod1="SELECT * FROM producto WHERE Id_producto='$id'";
                ...
                ?>
                <td class="text-center"><?php  echo $c["descripcion_producto"]  ; 
            } 
            $prod2->closeCursor();?></td>
                ...
                <td class="center">
                    ...
                    <a class="btn btn-danger" href="./php/inactivar_producto.php?Id='<?php echo $b['id_producto'];?>'&cod='<?php echo $factura_pendiente;?>'">
                ...
                <td class="center">
                    ...
                    <a class="btn btn-danger" href="./php/terminarcompra.php?Id='<?php echo $b['id_producto'];?>'&cod='<?php echo $factura_pendiente;?>'">
...
<div class="row">
    ...
    <div class="box-content">
         <div class="agregarproducto">
             <button href="#" type="button" id="nuevo_producto" class=" btn btn-info" data-toggle="modal">Nuevo producto</button>
         </div>
         ...
         <table class="table table-striped table-bordered bootstrap-datatable  responsive">
            <thead>
             ...
             <?php
                ...
                <td class="center"><?php  echo $aproducto['costo'];?></td>
                <td class="center"><?php  echo $aproducto['precio'];?></td>
                <td class="center"><?php  echo $aproducto['categoria'];?></td>
                <td class="center"><?php  echo $aproducto['cantidad'];?></td>
                <td class="center"><?php  echo $aproducto['Id_proveedor'];?></td>
